<section class="section emocional">
    ...
    <div class="confianza-grid flex-col-center">
        ...
        <div class="confianza-card flex-col-center reveal">
            <span>🤝</span>
            <h3>Sin niveles</h3>
    ...
    <p class="confianza-final">
        ...
        <span class="sandunguea-letter reveal">Solo necesitas atreverte.</span>
    </p>

    <div class="emocional-btn">

        <a href="#contacto" class="btn-primary reveal" data-mensaje="Hola, me interesa empezar a bailar 😅 ¿Me das información?">
